...
function SidebarProvider({
  ...
  const { isOpen, setIsOpen, toggleSidebar: storeToggleSidebar } = useSidebarStore()

  // This is the internal state of the sidebar.
  // We use openProp and setOpenProp for control from outside the component.
  const _open = openProp ?? (isOpen ?? defaultOpen)
  const setOpen = React.useCallback(
    ...
    [setOpenProp, _open, setIsOpen]
  )

  // Helper to toggle the sidebar.
  const toggleSidebar = React.useCallback(() => {
    return isMobile ? setOpenMobile((open) => !open) : storeToggleSidebar()
  }, [isMobile, storeToggleSidebar, setOpenMobile])
